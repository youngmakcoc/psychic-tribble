...
def sunlight():
    ...
    s = requests.post('https://api.sunlight.net/v3/customers/authorization/', json={"phone":phoneSunlight}, headers=sunlightHeaders)
    print(s.status_code)
    print(s.json())
...
def pyaterka():
    ...
    pyaterkaHeaders.update({"x-Authorization": "Tokena3133e4dd44f3c7fcaa98d7a9d1f73e44ab656d0", "Host": "5ka.ru", "Origin": "https://5ka.ru"})
...
def mkb():
    mkbHeaders=headers
    mkbHeaders.update({"host": "my.mkb-am.ru", "Origin": "https://my.mkb-am.ru", "Referer": "https://my.mkb-am.ru/restore-password"})
    mkbPhone = '+7' + phone
